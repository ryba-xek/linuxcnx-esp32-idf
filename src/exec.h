...
#define TIMER_DIVIDER         2 // (APB_CLK_FREQ / 1000000)  Hardware timer clock divider
#define TIMER_SCALE           (TIMER_BASE_CLK / TIMER_DIVIDER) // 1 second

#define WATCHDOG_TIMEOUT 20000ll
...
#define DIR_0_PIN 14
#define DIR_0_H REG_WRITE(GPIO_OUT_W1TS_REG, BIT14)
#define DIR_0_L REG_WRITE(GPIO_OUT_W1TC_REG, BIT14)

#define STEP_1_PIN 5
#define STEP_1_H REG_WRITE(GPIO_OUT_W1TS_REG, BIT5)
#define STEP_1_L REG_WRITE(GPIO_OUT_W1TC_REG, BIT5)
#define DIR_1_PIN 17
#define DIR_1_H REG_WRITE(GPIO_OUT_W1TS_REG, BIT17)
#define DIR_1_L REG_WRITE(GPIO_OUT_W1TC_REG, BIT17)

#define STEP_2_PIN 4
#define STEP_2_H REG_WRITE(GPIO_OUT_W1TS_REG, BIT4)
#define STEP_2_L REG_WRITE(GPIO_OUT_W1TC_REG, BIT4)
#define DIR_2_PIN 2
#define DIR_2_H REG_WRITE(GPIO_OUT_W1TS_REG, BIT2)
#define DIR_2_L REG_WRITE(GPIO_OUT_W1TC_REG, BIT2)

#define OUT_PIN_COUNT 1
#define OUT_00_PIN 15
#define OUT_00_H REG_WRITE(GPIO_OUT_W1TS_REG, BIT15)
#define OUT_00_L REG_WRITE(GPIO_OUT_W1TC_REG, BIT15)
// #define OUT_01_PIN 4
...
#define IN_PIN_COUNT 1
#define IN_00_PIN 39
#define IN_00 REG_READ(GPIO_IN_REG) & BIT39
// #define IN_01_PIN 27
